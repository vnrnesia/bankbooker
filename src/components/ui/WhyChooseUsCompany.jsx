...
const WhyChooseUsCompany = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="my-24 rounded-lg max-w- mx-auto font-[Manrope] min-h-[550px] bg-gradient-to-r from-sky-500 to-blue-600 px-4 flex items-center"
    >
      <div className="max-w-full mx-auto grid grid-cols-1 lg:grid-cols-2 pt-4 md:pt-0 gap-8 justify-center items-center ">
        {/* Left Card */}
        <div
          ref={leftCardRef}
          className="rounded-xl border-4 h-[500px] w-auto 3xl:min-w-[200px] border-gray-400 bg-gray-50 flex flex-col items-center justify-center p-8 text-center lg:rounded-r-none"
        >
...
export default WhyChooseUsCompany;
