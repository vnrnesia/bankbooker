...
const BankbookerLanding = () => {
  ...
  return (
    <>
    <div className="container  sm:ml-[2vw] md-lg:max-w-[89vw] md-lg::ml-[24vw] lg:max-w-[50vw] lg:ml-[24vw]  xl:max-w-[100vw] xl:ml-[1vw] 2xl:max-w-[70vw] 2xl-3xl:max-w-[57.5vw] 3xl:max-w-[100vw] 3xl:ml-[-50px] flex justify-center items-center">
      
    <div className="pt-24 md:pt-14 bg-white min-h-screen flex justify-center items-center">
      <div className="max-w-screen-lg mx-auto px-6">
        {/* Left Panel & Header */}
        <div className="flex flex-row">
          
          {/* Left Panel */}
          <div className="hidden md:flex min-w-[22vw] w-[40px] md:h-[980px] lg:h-[815px] xl:h-[767px] bg-gradient-to-b from-[#BEC0C4] to-[#DFE2E7] p-4 2xl:flex flex-col justify-between rounded-xl overflow-hidden lg:-ml-24 mr-8">
